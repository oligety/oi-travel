...
import { Mail, Lock, User, Eye, EyeOff, Map } from 'lucide-react';
    ...
    <main className="flex min-h-screen bg-zinc-950 text-zinc-50">
      ...
      <div className="relative hidden lg:flex flex-1 flex-col justify-between overflow-hidden bg-zinc-900/50 border-r border-white/5 p-12">
        <div className="absolute inset-0 z-0">
          <div className="absolute -left-20 bottom-0 h-96 w-96 rounded-full bg-emerald-600/20 blur-[100px]" />
          <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-primary-600/20 blur-[100px]" />
        </div>
        ...
        <div className="z-10 max-w-md">
          <h2 className="text-4xl font-light leading-tight mb-4 text-zinc-200">
            ...
            <span className="text-gradient font-semibold">with us today</span>
          </h2>
          <p className="text-zinc-400">
            Join thousands of travelers who organize their perfect itineraries
            and discover the world&apos;s hidden gems.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <form action={handleSubmit} className="flex flex-col gap-6 mt-4">
            <Input
              ...
              variant="bordered"
              size="lg"
              startContent={<User className="text-zinc-500" size={18} />}
              isRequired
              classNames={{
                inputWrapper:
